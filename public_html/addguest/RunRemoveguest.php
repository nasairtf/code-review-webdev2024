...
/**
 * /home/webdev2024/public_html/addguest/RunRemove.php
 *
 * The Removeguest form used to queue the removeguest command.
 *
 * @category Accounts
 * @package  IRTF
...
$debug->log("RunRemoveguest: Entry point debug|log mode is ON.");

// Initialize the form controller
$controller = new Controller($formatHtml, $debug);

// Process and render the form.
$controller->handleRequest('removeguest');
