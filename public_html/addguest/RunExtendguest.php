...
/**
 * /home/webdev2024/public_html/addguest/RunExtendguest.php
 *
 * The Extendguest form used to queue the extendguest command.
 *
 * @category Accounts
 * @package  IRTF
...
$debug->log("RunExtendguest: Entry point debug|log mode is ON.");

// Initialize the form controller
$controller = new Controller($formatHtml, $debug);

// Process and render the form.
$controller->handleRequest('extendguest');
