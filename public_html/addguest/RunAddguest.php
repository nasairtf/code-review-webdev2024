...
/**
 * /home/webdev2024/public_html/addguest/RunAddguest.php
 *
 * The Addguest form used to queue the addguest command.
 *
 * @category Accounts
 * @package  IRTF
...
$debug->log("RunAddguest: Entry point debug|log mode is ON.");

// Initialize the form controller
$controller = new Controller($formatHtml, $debug);

// Process and render the form.
$controller->handleRequest('addguest');
