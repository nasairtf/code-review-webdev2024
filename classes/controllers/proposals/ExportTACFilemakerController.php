...
use App\views\forms\proposals\ExportTACFilemakerView           as View;
use App\validators\forms\proposals\ExportTACFilemakerValidator as Validator;

/**
 * Controller for handling the Export TAC Filemaker logic.
 *
...
class ExportTACFilemakerController
{
    private $formatHtml;
    private $debug;
    private $manager;
    ...
    private function processFormSubmit(array $validData): void
    {
        ...
        try {
            ...
            $results = $this->manager->handleRequest($validData, true, 'filemaker');
            // Render the form with the results
            $this->renderResultsPage($results);
        } catch (Exception $e) {
            // Handle any errors during the data fetching process
            $this->renderErrorPage('Error processing TAC export: ', $e->getMessage());
        }
    }
    ...
    private function renderFormPage(): void
    {
        ...
        $pageTitle = "IRTF Export TAC Filemaker Form";
    ...
    private function renderResultsPage(
        ...
        $pageTitle = "IRTF Export TAC Filemaker File";
