...
class UploadTACCommentsValidator extends BaseValidator
{
    /**
    ...
    private function validateData(
        ...
        $valid['filess'] = $this->validateUploadedFile(
            $form['filess'],
            $form['path'],
            $allowedMimeTypes,
            'filess',
        ...
        // Validate uploaded `filenss`
        //$allowedMimeTypes = ['text/csv', 'text/plain', 'application/octet-stream'];
        $allowedMimeTypes = ['text/csv']; // Allowed MIME types for uploaded files
        $valid['filenss'] = $this->validateUploadedFile(
            $form['filenss'],
            $form['path'],
            $allowedMimeTypes,
            'filenss',
