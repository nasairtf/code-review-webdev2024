...
class ProcessObsRemindersView extends BaseView
{
    ...
    /**
     * Initializes the ProcessObsRemindersView with core builders and configurations.
     *
    ...
    protected function getPageContents(
        ...
        return $this->generateObsReminder($this->debug->isDebugMode(), $formData);
    }
}
