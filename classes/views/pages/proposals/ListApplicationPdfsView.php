...
/**
 * View for rendering the List Application Pdfs form.
 *
 * @category Views
 * @package  IRTF
...
class ListApplicationPdfsView extends BaseView
{
    /**
    ...
    protected function getPageContents(
        ...
        $instructions = 'Use the PDF links to download files. Missing files are flagged in red.';
        return $this->compBuilder->buildSemesterProposalListPage(
            $instructions,
            $dbData,
            [],
            $pad
